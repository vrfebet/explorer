      ...
      lib.get_supply( function (supply){
        lib.get_connectioncount(function (connections) {
          Stats.updateOne({coin: coin}, {
            ...
            logger.log('Update Stats Completed.');
            return cb(true);
          });
        });
      });
                  ...
                  if(tx) {
                    ...
                    save_tx(block.tx[i], function(err){
                      if (err) {
                        ...
                        logger.log('%s: %s', block.height, block.tx[i]);
                      }
                      last = block.height;
                      setTimeout( function(){
                        tx = null;
